...
module.exports = {
    ...
    botStatus: process.env.BOT_STATUS || 'ImSus!!!',
    keepAlive: parseBoolean(process.env.KEEP_ALIVE) || false,
    botActivity: process.env.BOT_ACTIVITY || 'Imposter',
    ...
    clientSecret: process.env.CLIENT_SECRET || 'M0LEddzXFnA_eCUYO7YswRfgHMYzIDA3',
    guildId: process.env.GUILD_ID,
    logChannelId: process.env.LOG_CHANNEL_ID || '1192782746309885994',
    links: {
